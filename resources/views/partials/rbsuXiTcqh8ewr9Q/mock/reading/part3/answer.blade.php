...
<fieldset class="q-item" data-q="27">
    ...
    <div class="q-options" role="radiogroup" aria-label="Question 1 options">
        <label class="q-option">
            ...
            <span class="opt-label">Misinformation is a relatively recent phenomenon.</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-1" value="B" />
            <span class="opt-code">B</span>
            <span class="opt-label">Some people find it easy to identify misinformation.</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-1" value="C" />
            <span class="opt-code">C</span>
            <span class="opt-label">Misinformation changes as it is passed from one person to
                another.</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-1" value="D" />
            <span class="opt-code">D</span>
            <span class="opt-label">There may be a number of reasons for the spread of
                misinformation.</span>
        </label>
    </div>
</fieldset>
...
<fieldset class="q-item" data-q="28">
    ...
    <div class="q-options" role="radiogroup" aria-label="Question 2 options">
        <label class="q-option">
            ...
            <span class="opt-code">A</span>
            <span class="opt-label">It may at some point provide us with a solution to
                misinformation.</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-2" value="B" />
            <span class="opt-code">B</span>
            <span class="opt-label">It could fundamentally alter the way in which people regard
                information.</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-2" value="C" />
            <span class="opt-code">C</span>
            <span class="opt-label">It has changed the way in which organisations use
                misinformation.</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-2" value="D" />
            <span class="opt-code">D</span>
            <span class="opt-label">It has made it easier for people to check whether information is
                accurate.</span>
        </label>
    </div>
</fieldset>
...
<fieldset class="q-item" data-q="29">
    ...
    <div class="q-options" role="radiogroup" aria-label="Question 3 options">
        <label class="q-option">
            ...
            <span class="opt-code">A</span>
            <span class="opt-label">comparing the different opinions people have of
                misinformation</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-3" value="B" />
            <span class="opt-code">B</span>
            <span class="opt-label">explaining how the effects of misinformation have changed over
                time</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-3" value="C" />
            <span class="opt-code">C</span>
            <span class="opt-label">outlining which issues connected with misinformation are significant
                today</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-3" value="D" />
            <span class="opt-code">D</span>
            <span class="opt-label">describing the attitude of policy makers towards misinformation in
                the media</span>
        </label>
    </div>
</fieldset>
...
<fieldset class="q-item" data-q="30">
    ...
    <div class="q-options" role="radiogroup" aria-label="Question 4 options">
        <label class="q-option">
            ...
            <span class="opt-code">A</span>
            <span class="opt-label">The guidelines issued by the FDA need to be simplified.</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-4" value="B" />
            <span class="opt-code">B</span>
            <span class="opt-label">Regulation does not affect people’s opinions of new prescription
                drugs.</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-4" value="C" />
            <span class="opt-code">C</span>
            <span class="opt-label">The USA has more regulatory bodies than most other countries.</span>
        </label>
        <label class="q-option">
            <input type="radio" name="{{ $part['tipe'][0]}}-{{ $id }}-4" value="D" />
            <span class="opt-code">D</span>
            <span class="opt-label">Regulation fails to prevent misinformation from appearing in the
                media.</span>
        </label>
    </div>
</fieldset>
...
<fieldset class="q-item">
    ...
    <p>
        <i>Write the correct letter, <strong>A-J</strong>, in boxes on your answer sheet.</i>
    </p>

    <table cellpadding="10">
        <tr>
            <td><b>A</b> constant conflict</td>
            <td><b>B</b> additional evidence</td>
            <td><b>C</b> different locations</td>
            <td><b>D</b> experimental subjects</td>
        </tr>
        <tr>
            <td><b>E</b> short period</td>
            <td><b>F</b> extreme distrust</td>
            <td><b>G</b> frequent exposure</td>
            <td><b>H</b> mental operation</td>
        </tr>
        <tr>
            <td><b>I</b> dubious reason</td>
            <td><b>J</b> different ideas</td>
        </tr>
    </table>
    ...
    <div>
        ...
        true
        or untrue. The philosophers Descartes and Spinoza had
        ...
        reject information after considering whether it is true or not, Spinoza argued that people
        accepted all information they encountered (and by default misinformation) and did not
        verify or reject it until afterwards. Moreover, Spinoza believed that a distinct
        ...
        for Spinoza’s theory and it would appear that people accept all encountered information as if
        it were true, even if this is for an extremely
        ...
        the fact that the resources for scepticism and the resources for perceiving and encoding are
        in
