    ...
    <div class="qa">
        <form class="qa-body" id="form-{{ $tab['id'] }}">
            <fieldset class="q-item">
                ...
                <div class="audio-player" data-player role="group" aria-label="Audio controls">
                    ...
                    <div class="start-buttons">
                        <button class="start-btn" data-start="118" type="button">Start from
                            here</button>
                    </div>
                </div>
            </fieldset>
            ...
            <table cellpadding="8" cellspacing="0" style="border-collapse: collapse; margin-bottom: 20px;">
                ...
                <tr>
                    <td>
                        ...
                        <div class="q-item" data-q="1">
                            ...
                            <input type="text" name="rbsuXiTcqh8ewr9Q-1" class="q-text" />
                            hectares
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <div class="q-item" data-q="2" style="display:inline-block;">
                            ...
                            <input type="text" name="rbsuXiTcqh8ewr9Q-2" class="q-text" />
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <div class="q-item" data-q="3" style="display:inline-block;">
                            ...
                            <input type="text" name="rbsuXiTcqh8ewr9Q-3" class="q-text" />
                        </div>
                        about plants, etc.
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <div class="q-item" data-q="4" style="display:inline-block;">
                            ...
                            <input type="text" name="rbsuXiTcqh8ewr9Q-4" class="q-text" />
                        </div>
                        and compass
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        Leisure and tourism: mostly concentrates on the rbsuXiTcqh8ewr9Q’s
                        <div class="q-item" data-q="5" style="display:inline-block;">
                            <span class="q-number-box">5</span>
                            <input type="text" name="rbsuXiTcqh8ewr9Q-5" class="q-text" />
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <div class="q-item" data-q="6" style="display:inline-block;">
                            ...
                            <input type="text" name="rbsuXiTcqh8ewr9Q-6" class="q-text" />
                        </div>
                ...
                <tr>
                    <td>
                        ...
                        <div class="q-item" data-q="7" style="display:inline-block;">
                            ...
                            <input type="text" name="rbsuXiTcqh8ewr9Q-7" class="q-text" />
                        </div>
                ...
                <tr>
                    <td>
                        ...
                        <div class="q-item" data-q="8" style="display:inline-block;">
                            ...
                            <input type="text" name="rbsuXiTcqh8ewr9Q-8" class="q-text" />
                        </div>
                ...
                <tr>
                    <td>
                        ...
                        <div class="q-item" data-q="9" style="display:inline-block;">
                            ...
                            <input type="text" name="rbsuXiTcqh8ewr9Q-9" class="q-text" />
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <div class="q-item" data-q="10" style="display:inline-block;">
                            ...
                            <input type="text" name="rbsuXiTcqh8ewr9Q-10" class="q-text" />
                        </div>
                        , free
                    </td>
                </tr>
