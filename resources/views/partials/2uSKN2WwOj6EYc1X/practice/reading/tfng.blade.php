        ...
        <aside class="qa" aria-label="Questions">
            <form class="qa-body" id="form-{{ $tab['id'] }}">
                ...
                <fieldset class="q-item" data-q="1">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-1" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-1" value="FALSE">
                ...
                <fieldset class="q-item" data-q="2">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-2" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-2" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
                ...
                <fieldset class="q-item" data-q="3">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-3" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-3" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
                ...
                <fieldset class="q-item" data-q="4">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-4" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-4" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
                ...
                <fieldset class="q-item" data-q="5">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-5" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-5" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
                ...
                <fieldset class="q-item" data-q="6">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-6" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="2uSKN2WwOj6EYc1X-6" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
