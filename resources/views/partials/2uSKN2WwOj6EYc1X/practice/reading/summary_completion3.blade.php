                        ...
                        <p>
                            ...
                            <span style="flex: 1;">
                                <span class="q-question">
                                    <input type="text" name="2uSKN2WwOj6EYc1X-12" class="q-text" placeholder="">
                                </span>
                            ...
                            <span style="flex: 1;">
                                <span class="q-question">
                                    <input type="text" name="2uSKN2WwOj6EYc1X-13" class="q-text" placeholder="">
                                </span>
                            </span> to use the resource many times over. People should need a
                            <span class="q-number-box">3</span>
                            <span style="flex: 1;">
                                <span class="q-question">
                                    <input type="text" name="2uSKN2WwOj6EYc1X-14" class="q-text" placeholder="">
                                </span>
                            </span> to access helium that we still have. Furthermore, a
                            <span class="q-number-box">4</span>
                            <span style="flex: 1;">
                                <span class="q-question">
                                    <input type="text" name="2uSKN2WwOj6EYc1X-15" class="q-text" placeholder="">
                                </span>
