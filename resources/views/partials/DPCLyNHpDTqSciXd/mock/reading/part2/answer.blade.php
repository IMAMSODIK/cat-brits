...
<fieldset class="q-item">
    ...
    <p>
        Match each statement with the correct researcher, <b>A–D</b>.
    </p>
    <p>
        Write the correct letter, <b>A–D</b>, in boxes on your answer sheet.
    </p>
    <p><i><b>NB</b> You may use any letter more than once.</i></p>

    <p><b>List of Researchers</b></p>
    <ul class="legend">
        <li><strong>A</strong> Jorg Kudla</li>
        <li><strong>B</strong> Caixia Gao</li>
        <li><strong>C</strong> Joyce Van Eck</li>
        <li><strong>D</strong> Jonathan Jones</li>
    </ul>
</fieldset>
...
<fieldset class="q-item" data-q="1">
    <legend class="q-text" style="display:flex; gap:6px;">
        ...
        <span style="flex:1;">
            Domestication of certain plants could allow them to adapt to future environmental
            challenges.
            <span class="q-question">
