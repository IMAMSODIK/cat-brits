...
<fieldset class="q-item">
    ...
    <p class="lead">Complete the summary using the list of phrases, <strong>A-K</strong>, below.</p>
    <p><i>Write the correct letter, <strong>A-K</strong>, in boxes on your answer sheet.</i></p>
    <table cellpadding="6">
        <tr>
            <td><b>A</b> appeal</td>
            <td><b>B</b> determined</td>
            <td><b>C</b> intrigued</td>
        </tr>
        <tr>
            <td><b>D</b> single</td>
            <td><b>E</b> achievement</td>
            <td><b>F</b> devoted</td>
        </tr>
        <tr>
            <td><b>G</b> involved</td>
            <td><b>H</b> unique</td>
            <td><b>I</b> innovative</td>
        </tr>
        <tr>
            <td><b>J</b> satisfaction</td>
            <td><b>K</b> intent</td>
            <td></td>
        </tr>
    </table>
...
<fieldset class="q-item">
    ...
    <p class="lead">Do the following statements agree with the claims of the writer in Reading Passage?
    </p>
...
<fieldset class="q-item">
    <p class="lead"><b>Questions 38-40</b></p>
