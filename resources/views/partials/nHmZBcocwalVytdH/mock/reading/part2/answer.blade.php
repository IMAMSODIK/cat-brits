...
<fieldset class="q-item">
    ...
    <ul class="legend">
        ...
        <li><strong>ix</strong> Evidence that a certain approach can have more disadvantages that
            advantages</li>
    </ul>
</fieldset>
<fieldset class="q-item" data-q="1">
