...
<fieldset class="q-item">
    ...
    <p class="lead">The Reading Passage has six sections, A-F.</p>
...
<fieldset class="q-item">
    ...
    <p class="lead">Match each statement with the correct person, A, B, C or D.</p>
    <p>Write the correct letter, <b>A, B, C or D</b>, in boxes on your answer sheet.</p>
    <p>NB &nbsp;&nbsp;You may use any letter more than once.</p>
</fieldset>

<fieldset class="q-item">
    <p><b>List of People</b></p>
    <p><b>A</b>&nbsp;&nbsp;Carolin Frueh</p>
    <p><b>B</b>&nbsp;&nbsp;Holger Krag</p>
    <p><b>C</b>&nbsp;&nbsp;Marlon Sorge</p>
...
<fieldset class="q-item" data-q="40">
    <legend class="q-text">
        ...
        <span class="q-question">
            <select name="{{ $part['tipe'][2] }}-{{ $id }}-8" class="q-dropdown">
                <option value=""></option>
                <option value="A">A</option>
                <option value="B">B</option>
                <option value="C">C</option>
