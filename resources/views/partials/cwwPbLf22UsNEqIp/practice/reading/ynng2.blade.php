            ...
            <form class="qa-body" id="form-{{ $tab['id'] }}">
                ...
                <fieldset class="q-item" data-q="1">
                    ...
                    <div class="q-options" role="radiogroup" aria-label="Question 33 options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-7" value="YES" />
                            <span class="opt-code">A</span>
                            <span class="opt-label">YES</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-7" value="NO" />
                            <span class="opt-code">B</span>
                            <span class="opt-label">NO</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-7" value="NOT GIVEN" />
                ...
                <fieldset class="q-item" data-q="2">
                    ...
                    <div class="q-options" role="radiogroup" aria-label="Question 34 options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-8" value="YES" />
                            <span class="opt-code">A</span>
                            <span class="opt-label">YES</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-8" value="NO" />
                            <span class="opt-code">B</span>
                            <span class="opt-label">NO</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-8" value="NOT GIVEN" />
                            <span class="opt-code">C</span>
                            <span class="opt-label">NOT GIVEN</span>
                        </label>
                    </div>
                ...
                <fieldset class="q-item" data-q="3">
                    ...
                    <div class="q-options" role="radiogroup" aria-label="Question 35 options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-9" value="YES" />
                            <span class="opt-code">A</span>
                            <span class="opt-label">YES</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-9" value="NO" />
                            <span class="opt-code">B</span>
                            <span class="opt-label">NO</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-9" value="NOT GIVEN" />
                            <span class="opt-code">C</span>
                            <span class="opt-label">NOT GIVEN</span>
                        </label>
                    </div>
                ...
                <fieldset class="q-item" data-q="4">
                    ...
                    <div class="q-options" role="radiogroup" aria-label="Question 36 options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-10" value="YES" />
                            <span class="opt-code">A</span>
                            <span class="opt-label">YES</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-10" value="NO" />
                            <span class="opt-code">B</span>
                            <span class="opt-label">NO</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-10" value="NOT GIVEN" />
                            <span class="opt-code">C</span>
                            <span class="opt-label">NOT GIVEN</span>
                        </label>
                    </div>
