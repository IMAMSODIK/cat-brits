@props(['tab'])
<div class="x-panel-inner">Content: Reading Passage 3</div>
<div class="reading-section" aria-label="Reading and Questions">
    <div class="reading-grid resizable-grid highlighted-content">
        <article class="passage" aria-label="Reading Passage" tabindex="0">
            <div class="passage-body">
                <h3 style="text-align: center"><b>HELIUM'S FUTURE UP IN THE AIR</b></h3>
                <h3>A</h3>
                <p>
                    ...
                    non-renewable resource continues without receiving much press at all. Helium - an inert,
                ...
                <p>
                    ...
                    proportion – 0.00052%, to be exact – remains in earth's atmosphere. Helium is the
                    by-product of millennia of radioactive decay from the elements thorium and uranium. The
                ...
                <p>
                    ...
                    novelty substance for parties and gimmicks, the element actually has many vital
                    ...
                    Hindenburg catastrophe in 1932, during which an airship burst into flames and crashed
                    to the ground killing some passengers and crew). But helium is also instrumental in
                    deep-sea diving, where it is blended with nitrogen to mitigate the dangers of inhaling
                    ordinary air under high pressure; as a cleaning agent for rocket engines; and, in its most
                    prevalent use, as a coolant for superconducting magnets in hospital MRI (magnetic
        ...
        <aside class="qa" aria-label="Questions">
            <form class="qa-body" id="form-{{ $tab['id'] }}">
                <fieldset class="q-item">
                    ...
                    <p>
                    <div>
                        Sobotka argues that big business and users of helium need to help look after helium stocks because prudent practice will not be encouraged through buying and selling alone. Richardson believes that the
                        <span class="q-number-box">1</span>
                        <span style="flex: 1;">
                            <span class="q-question">
                                <input type="text" name="cwwPbLf22UsNEqIp-9" class="q-text" placeholder="">
                            </span>
                        </span>needs to be withdrawn, as the U.S. provides most of the world's helium. He argues that higher costs would mean people have 
                        ...
                        <span style="flex: 1;">
                            <span class="q-question">
                                <input type="text" name="cwwPbLf22UsNEqIp-11" class="q-text" placeholder="">
                            </span>
                        </span> to access helium that we still have. Furthermore, a
                        <span class="q-number-box">4</span>
                        <span style="flex: 1;">
                            <span class="q-question">
                                <input type="text" name="cwwPbLf22UsNEqIp-12" class="q-text" placeholder="">
                            </span>
