        ...
        <aside class="qa" aria-label="Questions">
            <form class="qa-body" id="form-{{ $tab['id'] }}">
                <fieldset class="q-item">
                    ...
                    <p>In boxes <b>1-6</b> on your answer sheet, write</p>
                    <ul class="legend">
                ...
                <fieldset class="q-item" data-q="1">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-1" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-1" value="FALSE">
                ...
                <fieldset class="q-item" data-q="2">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-2" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-2" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
                ...
                <fieldset class="q-item" data-q="3">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-3" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-3" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
                ...
                <fieldset class="q-item" data-q="4">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-4" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-4" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
                ...
                <fieldset class="q-item" data-q="5">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-5" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-5" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
                ...
                <fieldset class="q-item" data-q="6">
                    ...
                    <div class="q-options">
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-6" value="TRUE">
                            <span class="opt-code">A</span>
                            <span class="opt-label">TRUE</span>
                        </label>
                        <label class="q-option">
                            <input type="radio" name="cwwPbLf22UsNEqIp-6" value="FALSE">
                            <span class="opt-code">B</span>
                            <span class="opt-label">FALSE</span>
                        </label>
                        <label class="q-option">
