                ...
                <form class="qa-body" id="form-{{ $tab['id'] }}">
                    ...
                    <fieldset class="q-item" data-q="3">
                        ...
                        <div class="q-options" role="radiogroup" aria-label="Question 3 options">
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-6" value="A" />
                                <span class="opt-code">A</span>
                                <span class="opt-label">the area where writing began</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-6" value="B" />
                                <span class="opt-code">B</span>
                                <span class="opt-label">the nature of early writing materials</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-6" value="C" />
                                <span class="opt-code">C</span>
                                <span class="opt-label">the way writing began</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-6" value="D" />
                                <span class="opt-code">D</span>
                    ...
                    <fieldset class="q-item" data-q="4">
                        ...
                        <div class="q-options" role="radiogroup" aria-label="Question 3 options">
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-7" value="A" />
                                <span class="opt-code">A</span>
                                <span class="opt-label">grew out of accountancy</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-7" value="B" />
                                <span class="opt-code">B</span>
                                <span class="opt-label">evolved from pictures</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-7" value="C" />
                                <span class="opt-code">C</span>
                                <span class="opt-label">was initially intended as decoration</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-7" value="D" />
                                <span class="opt-code">D</span>
