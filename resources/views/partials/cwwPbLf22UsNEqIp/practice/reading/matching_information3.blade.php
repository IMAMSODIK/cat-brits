                ...
                <form class="qa-body" id="form-{{ $tab['id'] }}">
                    ...
                    <fieldset class="q-item" data-q="1">
                        ...
                        <div class="q-options" role="radiogroup" aria-label="Question 1 options">
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-8" value="A" />
                                <span class="opt-code">A</span>
                                <span class="opt-label">Dr Holly Pittman</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-8" value="B" />
                                <span class="opt-code">B</span>
                                <span class="opt-label">Dr Peter Damerow</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-8" value="C" />
                                <span class="opt-code">C</span>
                                <span class="opt-label">Dr Denise Schmandt-Besserat</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-8" value="D" />
                                <span class="opt-code">D</span>
                                <span class="opt-label">Dr Piotr Michalowski</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-8" value="E" />
                    ...
                    <fieldset class="q-item" data-q="2">
                        ...
                        <div class="q-options" role="radiogroup" aria-label="Question 2 options">
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-9" value="A" />
                                <span class="opt-code">A</span>
                                <span class="opt-label">Dr Holly Pittman</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-9" value="B" />
                                <span class="opt-code">B</span>
                                <span class="opt-label">Dr Peter Damerow</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-9" value="C" />
                                <span class="opt-code">C</span>
                                <span class="opt-label">Dr Denise Schmandt-Besserat</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-9" value="D" />
                                <span class="opt-code">D</span>
                                <span class="opt-label">Dr Piotr Michalowski</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-9" value="E" />
                                <span class="opt-code">E</span>
                                <span class="opt-label">Dr Pascal Vernus</span>
                            </label>
                        </div>
                    ...
                    <fieldset class="q-item" data-q="3">
                        ...
                        <div class="q-options" role="radiogroup" aria-label="Question 3 options">
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-10" value="A" />
                                <span class="opt-code">A</span>
                                <span class="opt-label">Dr Holly Pittman</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-10" value="B" />
                                <span class="opt-code">B</span>
                                <span class="opt-label">Dr Peter Damerow</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-10" value="C" />
                                <span class="opt-code">C</span>
                                <span class="opt-label">Dr Denise Schmandt-Besserat</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-10" value="D" />
                                <span class="opt-code">D</span>
                                <span class="opt-label">Dr Piotr Michalowski</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-10" value="E" />
                                <span class="opt-code">E</span>
                                <span class="opt-label">Dr Pascal Vernus</span>
                            </label>
                        </div>
                    ...
                    <fieldset class="q-item" data-q="4">
                        ...
                        <div class="q-options" role="radiogroup" aria-label="Question 3 options">
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-11" value="A" />
                                <span class="opt-code">A</span>
                                <span class="opt-label">Dr Holly Pittman</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-11" value="B" />
                                <span class="opt-code">B</span>
                                <span class="opt-label">Dr Peter Damerow</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-11" value="C" />
                                <span class="opt-code">C</span>
                                <span class="opt-label">Dr Denise Schmandt-Besserat</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-11" value="D" />
                                <span class="opt-code">D</span>
                                <span class="opt-label">Dr Piotr Michalowski</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-11" value="E" />
                                <span class="opt-code">E</span>
                                <span class="opt-label">Dr Pascal Vernus</span>
                            </label>
                        </div>
                    ...
                    <fieldset class="q-item" data-q="5">
                        ...
                        <div class="q-options" role="radiogroup" aria-label="Question 3 options">
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-12" value="A" />
                                <span class="opt-code">A</span>
                                <span class="opt-label">Dr Holly Pittman</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-12" value="B" />
                                <span class="opt-code">B</span>
                                <span class="opt-label">Dr Peter Damerow</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-12" value="C" />
                                <span class="opt-code">C</span>
                                <span class="opt-label">Dr Denise Schmandt-Besserat</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-12" value="D" />
                                <span class="opt-code">D</span>
                                <span class="opt-label">Dr Piotr Michalowski</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-12" value="E" />
                                <span class="opt-code">E</span>
                                <span class="opt-label">Dr Pascal Vernus</span>
                            </label>
                        </div>
                    ...
                    <fieldset class="q-item" data-q="6">
                        ...
                        <div class="q-options" role="radiogroup" aria-label="Question 3 options">
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-13" value="A" />
                                <span class="opt-code">A</span>
                                <span class="opt-label">Dr Holly Pittman</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-13" value="B" />
                                <span class="opt-code">B</span>
                                <span class="opt-label">Dr Peter Damerow</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-13" value="C" />
                                <span class="opt-code">C</span>
                                <span class="opt-label">Dr Denise Schmandt-Besserat</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-13" value="D" />
                                <span class="opt-code">D</span>
                                <span class="opt-label">Dr Piotr Michalowski</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="cwwPbLf22UsNEqIp-13" value="E" />
                                <span class="opt-code">E</span>
                                <span class="opt-label">Dr Pascal Vernus</span>
                            </label>
                        </div>
