                ...
                <fieldset class="q-item">
                    ...
                    <div>
                        <p>
                            ...
                            <span style="flex: 1;">
                                <span class="q-question">
                                    <input type="text" name="cwwPbLf22UsNEqIp-13" class="q-text" placeholder="">
                                </span>
                            </span> to use the resource many times over. People should need a
                            <span class="q-number-box">3</span>
                            <span style="flex: 1;">
                                <span class="q-question">
                                    <input type="text" name="cwwPbLf22UsNEqIp-14" class="q-text" placeholder="">
                                </span>
                            </span> to access helium that we still have. Furthermore, a
                            <span class="q-number-box">4</span>
                            <span style="flex: 1;">
                                <span class="q-question">
                                    <input type="text" name="cwwPbLf22UsNEqIp-15" class="q-text" placeholder="">
                                </span>
