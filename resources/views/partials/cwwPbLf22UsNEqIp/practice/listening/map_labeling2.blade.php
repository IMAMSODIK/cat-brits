            ...
            <fieldset class="q-item" data-q="3">
                <legend class="q-text" style="display: flex; align-items: center; gap: 6px;">
                    <span class="q-item" data-q="3">
                        ...
                        <input type="text" name="cwwPbLf22UsNEqIp-10" class="q-text" />
                    </span>
                </legend>
            </fieldset>
            <fieldset class="q-item" data-q="4">
                <legend class="q-text" style="display: flex; align-items: center; gap: 6px;">
                    <span class="q-item" data-q="4">
                        ...
                        <input type="text" name="cwwPbLf22UsNEqIp-11" class="q-text" />
                    </span>
                </legend>
            </fieldset>
            <fieldset class="q-item" data-q="5">
                <legend class="q-text" style="display: flex; align-items: center; gap: 6px;">
                    <span class="q-item" data-q="5">
                        ...
                        <input type="text" name="cwwPbLf22UsNEqIp-12" class="q-text" />
                    </span>
                </legend>
            </fieldset>
