...
@section('own_style')
    ...
    .custom-card {
        height: 260px; /* Diperkecil dari 320px */
        cursor: pointer;
        ...
        box-shadow: 0 3px 8px rgba(0, 0, 0, 0.07); /* Shadow lebih ringan */
        margin-bottom: 20px;
        display: flex;
    ...
    /* Hover effect */
    .custom-card:hover {
        transform: translateY(-5px); /* Efek hover lebih kecil */
        box-shadow: 0 10px 20px rgba(33, 107, 212, 0.12); /* Shadow lebih ringan */
    }
    ...
    .custom-card .card-header {
        ...
        color: white;
        border-radius: 10px 10px 0 0 !important; /* Diperkecil */
        padding: 15px 12px; /* Padding diperkecil */
        border-bottom: none;
        position: relative;
        overflow: hidden;
        min-height: 70px; /* Tinggi header dikurangi */
        display: flex;
        align-items: center;
    }
    ...
    .card-text {
        ...
        margin-bottom: 0;
        display: -webkit-box;
        -webkit-line-clamp: 3; /* Jumlah baris dikurangi */
        -webkit-box-orient: vertical;
        overflow: hidden;
        text-overflow: ellipsis;
    }
    ...
    .custom-card .card-footer {
        ...
        padding: 12px 12px; /* Padding diperkecil */
        border-radius: 0 0 10px 10px; /* Diperkecil */
        display: flex;
        justify-content: space-between;
        align-items: center;
        min-height: 55px; /* Tinggi footer dikurangi */
    }
    ...
    .access-btn i {
        margin-left: 4px;
        font-size: 0.8rem; /* Ikon lebih kecil */
    ...
    @media (max-width: 768px) {
        .custom-card {
            height: 240px; /* Lebih kecil di tablet */
        }
    ...
    @media (max-width: 576px) {
        ...
        .card-text {
            font-size: 0.82rem;
            -webkit-line-clamp: 2; /* Lebih sedikit baris di mobile */
        }
    ...
    .data-ctr {
        margin: 0 -8px; /* Mengurangi margin untuk kepadatan lebih */
    }
