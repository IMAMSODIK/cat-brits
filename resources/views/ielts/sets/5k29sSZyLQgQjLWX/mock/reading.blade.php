            ...
            $tabs = [
                ...
                'data' => [
                    'part1' => [
                        ...
                        'tipe' => ['nc', 'tfng'],
                        'contents' => [
                            'answer' => 'partials.5k29sSZyLQgQjLWX.mock.reading.part1.answer',
                            'question' => 'partials.5k29sSZyLQgQjLWX.mock.reading.part1.question',
                        ],
                    ],
                    'part2' => [
                        'label' => 'Part 2',
                        'tipe' => ['matching_information', 'tfng', 'two_choices', 'two_choices'],
                        'contents' => [
                            'answer' => 'partials.5k29sSZyLQgQjLWX.mock.reading.part2.answer',
                            'question' => 'partials.5k29sSZyLQgQjLWX.mock.reading.part2.question',
                        ],
                    ],
                    'part3' => [
                        'label' => 'Part 3',
                        'tipe' => ['tfng', 'nc', 'oc'],
                        'contents' => [
                            'answer' => 'partials.5k29sSZyLQgQjLWX.mock.reading.part3.answer',
                            'question' => 'partials.5k29sSZyLQgQjLWX.mock.reading.part3.question',
                        ],
                    ],
                ],
            ];
