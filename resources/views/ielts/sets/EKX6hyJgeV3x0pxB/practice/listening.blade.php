                            ...
                            <ul>
                                <li>
                                    <div class="q-list" data-q="4">
                                        ...
                                        <span class="q-number-box">4</span>
                                        <input type="text" name="s4gzzYRpwLnhLRFf-14" class="q-text" placeholder="">
                                        The 
                                    </div>
                                    <div class="q-list" data-q="5">
                                        Advertising focused on its
                                        <span class="q-number-box">5</span>
                                        <input type="text" name="s4gzzYRpwLnhLRFf-15" class="q-text" placeholder="">
                                        benefits.
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="q-list" data-q="6">
                                        ...
                                        <span class="q-number-box">6</span>
                                        <input type="text" name="s4gzzYRpwLnhLRFf-16" class="q-text" placeholder="">
                                        shops reduced the need for advertising.
                                    </div>
                                    <div class="q-list" data-q="7">
                                        It appealed to consumers who are concerned about the
                                        <span class="q-number-box">7</span>
                                        <input type="text" name="s4gzzYRpwLnhLRFf-17" class="q-text" placeholder="">
                                        benefits.
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li>
                                    <div class="q-list" data-q="8">
                                        ...
                                        <span class="q-number-box">8</span>
                                        <input type="text" name="s4gzzYRpwLnhLRFf-18" class="q-text" placeholder="">
                            ...
                            <ul>
                                <li>
                                    <div class="q-list" data-q="9">
                                        ...
                                        <span class="q-number-box">9</span>
                                        <input type="text" name="s4gzzYRpwLnhLRFf-19" class="q-text" placeholder="">
                                    </div>
                                </li>
                                <li>
                                    <div class="q-list" data-q="10">
                                        ...
                                        <span class="q-number-box">10</span>
                                        <input type="text" name="s4gzzYRpwLnhLRFf-20" class="q-text" placeholder="">
                                    </div>
                                </li>
                            </ul>
                        </fieldset>
