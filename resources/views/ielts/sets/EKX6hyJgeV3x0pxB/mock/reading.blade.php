                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-EKX6hyJgeV3x0pxB-1" class="q-text" placeholder="">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-EKX6hyJgeV3x0pxB-2" class="q-text" placeholder="">
                                        ...
                                        <input type="text" name="summary_completion-EKX6hyJgeV3x0pxB-3" class="q-text" placeholder="">
                                    </p>
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-EKX6hyJgeV3x0pxB-4" class="q-text" placeholder="">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-EKX6hyJgeV3x0pxB-5" class="q-text" placeholder="">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-EKX6hyJgeV3x0pxB-6" class="q-text" placeholder="">
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        <div>
                                            ...
                                            <span style="flex: 1;">
                                                <span class="q-question">
                                                    <select name="summary_completion-EKX6hyJgeV3x0pxB-1" data-q="33" class="q-dropdown">
                                                        <option value=""></option>
                                                        <option value="A">A</option>
                                                        <option value="B">B</option>
                                                        <option value="C">C</option>
                                            ...
                                            <span style="flex: 1;">
                                                <span class="q-question">
                                                    <select name="summary_completion-EKX6hyJgeV3x0pxB-2" data-q="34" class="q-dropdown">
                                                        <option value=""></option>
                                                        <option value="A">A</option>
                                                        <option value="B">B</option>
                                                        <option value="C">C</option>
                                            ...
                                            <span style="flex: 1;">
                                                <span class="q-question">
                                                    <select name="summary_completion-EKX6hyJgeV3x0pxB-3" data-q="35" class="q-dropdown">
                                                        <option value=""></option>
                                                        <option value="A">A</option>
                                                        <option value="B">B</option>
                                                        <option value="C">C</option>
                                    ...
                                    <p>
                                        <div>
                                            ...
                                            <span style="flex: 1;">
                                                <span class="q-question">
                                                    <select name="summary_completion-EKX6hyJgeV3x0pxB-4" data-q="36" class="q-dropdown">
                                                        <option value=""></option>
                                                        <option value="A">A</option>
                                                        <option value="B">B</option>
                                                        <option value="C">C</option>
                                            ...
                                            <span style="flex: 1;">
                                                <span class="q-question">
                                                    <select name="summary_completion-EKX6hyJgeV3x0pxB-5" data-q="37" class="q-dropdown">
                                                        <option value=""></option>
                                                        <option value="A">A</option>
                                                        <option value="B">B</option>
                                                        <option value="C">C</option>
