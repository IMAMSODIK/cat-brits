...
@include('ielts.sets.layouts.practice.writing.head')

<body>
    @include('ielts.sets.layouts.practice.writing.header')
                        ...
                        <div class="reading-grid resizable-grid">
                            <article class="passage" aria-label="Reading Passage" tabindex="0">
                                <div class="passage-body">
                                    <p>The first chart below shows how energy is used in an average Australian
                                        household.
                                        The second chart shows the greenhouse gas emissions which result from this
                                        energy use.</p>
                                    ...
                                    <div class="form-container">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <textarea name="answers[Task 1]" class="form-textarea js-response" data-task="Task 1" data-no-soal="1" placeholder="Enter your Task 1 Answer" spellcheck="false"></textarea>
                ...
                <div id="panel-tfng2" class="x-panel" role="tabpanel" aria-labelledby="tab-tfng2">
                    ...
                    <div class="reading-section" aria-label="Reading and Questions">
                        <div class="reading-grid resizable-grid">
                            <article class="passage" aria-label="Reading Passage" tabindex="0">
                                <div class="passage-body">
                                    <p>It is important for children to learn the difference between right and wrong at
                                        an early age.
                                    ...
                                    <p>What sort of punishment should parents and teachers be allowed to use to teach
                                        good behaviour to children?</p>
                                </div>
                            </article>
                                    ...
                                    <div class="form-container">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <textarea name="answers[Task 2]" class="form-textarea js-response" data-task="Task 2" data-no-soal="1" placeholder="Enter your Task 2 Answer" spellcheck="false"></textarea>
                                                <div class="char-counter">
                                                    <span class="char-info"><span class="char-count">0</span>
                                                        Words</span>
                                                </div>
