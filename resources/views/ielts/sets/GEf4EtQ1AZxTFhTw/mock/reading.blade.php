                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-1kxpl5g3zFLGtmEY-1" class="q-text" placeholder="">
                                        . They were concerned about damage to the environment and about
                                        <span class="q-number-box">24</span>
                                        <input type="text" name="summary_completion-1kxpl5g3zFLGtmEY-2" class="q-text" placeholder="">
                                        ...
                                        <input type="text" name="summary_completion-1kxpl5g3zFLGtmEY-3" class="q-text" placeholder="">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-1kxpl5g3zFLGtmEY-4" class="q-text" placeholder="">
                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-1kxpl5g3zFLGtmEY-5" class="q-text" placeholder="">
                                        . They discovered that activities designed for staff to have fun improved their
                                        <span class="q-number-box">37</span>
                                        <input type="text" name="summary_completion-1kxpl5g3zFLGtmEY-6" class="q-text" placeholder="">
                                        , and that management involvement led to lower staff
                                        <span class="q-number-box">38</span>
                                        <input type="text" name="summary_completion-1kxpl5g3zFLGtmEY-7" class="q-text" placeholder="">
                                        . They also found that the activities needed to fit with both the company’s
                                        <span class="q-number-box">39</span>
                                        <input type="text" name="summary_completion-1kxpl5g3zFLGtmEY-8" class="q-text" placeholder="">
                                        and the
                                        <span class="q-number-box">40</span>
                                        <input type="text" name="summary_completion-1kxpl5g3zFLGtmEY-9" class="q-text" placeholder="">
