...
<body>
                        ...
                        <form class="qa-body" id="form-nc">
                            <fieldset class="q-item">
                                ...
                                <div class="audio-player" data-player role="group" aria-label="Audio controls">
                                    <audio preload="auto"
                                        src="https://engnovate.com/wp-content/uploads/2024/08/cambridge-ielts-19-academic-listening-3-audio-1.mp3">
                                    </audio>
                            ...
                            <fieldset class="q-item">
                                ...
                                <p>
                                    ...
                                    <input type="text" name="GEf4EtQ1AZxTFhTw-1" class="q-text"
                                        placeholder="">
                                </p>
                                ...
                                <p>
                                    ...
                                    <input type="text" name="GEf4EtQ1AZxTFhTw-2" class="q-text"
                                        placeholder="">
                                    and turn right
                                </p>
                                <p>
                                    ...
                                    <input type="text" name="GEf4EtQ1AZxTFhTw-3" class="q-text"
                                        placeholder="">
                                ...
                                <p>
                                    ...
                                    <input type="text" name="GEf4EtQ1AZxTFhTw-4" class="q-text"
                                        placeholder="">
                                </p>
                                ...
                                <p>
                                    ...
                                    <input type="text" name="GEf4EtQ1AZxTFhTw-5" class="q-text"
                                        placeholder="">
                                    outside
                                </p>
                                ...
                                <p>
                                    ...
                                    <input type="text" name="GEf4EtQ1AZxTFhTw-6" class="q-text"
                                        placeholder="">
                                    minibus, number 289
                                </p>
                            </fieldset>
                    ...
                    <form class="qa-body" id="form-tc">
                        <fieldset class="q-item">
                            ...
                            <div class="audio-player" data-player role="group" aria-label="Audio controls">
                                ...
                                <div class="start-buttons">
                                    <button class="start-btn" data-start="268" type="button">Start from
                                        here</button>
                                </div>
                            </div>
                        </fieldset>
                    ...
                    <div class="qa highlighted-content" aria-label="Questions">
                        <form class="qa-body" id="form-matching_information">
                            <fieldset class="q-item">
                                ...
                                <div class="audio-player" data-player role="group" aria-label="Audio controls">
                                    <audio preload="auto"
                                        src="https://engnovate.com/wp-content/uploads/2024/08/cambridge-ielts-19-academic-listening-3-audio-2.mp3">
                                    </audio>
                        ...
                        <form class="qa-body" id="form-two_choices">
                            <fieldset class="q-item">
                                ...
                                <div class="audio-player" data-player role="group" aria-label="Audio controls">
                                    ...
                                    <div class="start-buttons">
                                        <button class="start-btn" data-start="234" type="button">Start from
                                            here</button>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="q-item" data-q="1" data-q-multi="1,2" data-max="2">
                                ...
                                <div class="q-options" role="group" aria-label="Question 1 options">
                                    <label class="q-option">
                                        <input type="checkbox" name="GEf4EtQ1AZxTFhTw-1[]" value="A" />
                                        <span class="opt-code">A</span>
                                        <span class="opt-label">It will appeal to both boys and girls.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="checkbox" name="GEf4EtQ1AZxTFhTw-1[]" value="B" />
                                        <span class="opt-code">B</span>
                                        <span class="opt-label">The author is well known.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="checkbox" name="GEf4EtQ1AZxTFhTw-1[]" value="C" />
                                        <span class="opt-code">C</span>
                                        <span class="opt-label">It has colourful illustrations.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="checkbox" name="GEf4EtQ1AZxTFhTw-1[]" value="D" />
                                        <span class="opt-code">D</span>
                                        <span class="opt-label">It is funny.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="checkbox" name="GEf4EtQ1AZxTFhTw-1[]" value="E" />
                        ...
                        <form class="qa-body" id="form-oc">
                            ...
                            <fieldset class="q-item" data-q="1">
                                ...
                                <div class="q-options" role="radiogroup" aria-label="Question 1 options">
                                    <label class="q-option">
                                        <input type="radio" name="GEf4EtQ1AZxTFhTw-1" value="A" />
                                        <span class="opt-code">A</span>
                                        <span class="opt-label">worried that they are not making progress</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="radio" name="GEf4EtQ1AZxTFhTw-1" value="B" />
                                        <span class="opt-code">B</span>
                                        <span class="opt-label">challenged by their poor behaviour in class</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="radio" name="GEf4EtQ1AZxTFhTw-1" value="C" />
                                        <span class="opt-code">C</span>
                            ...
                            <fieldset class="q-item" data-q="3">
                                ...
                                <div class="q-options" role="radiogroup" aria-label="Question 1 options">
                                    <label class="q-option">
                                        <input type="radio" name="GEf4EtQ1AZxTFhTw-3" value="A" />
                                        <span class="opt-code">A</span>
                                        <span class="opt-label">Any results may not apply to humans.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="radio" name="GEf4EtQ1AZxTFhTw-3" value="B" />
                                        <span class="opt-code">B</span>
                                        <span class="opt-label">It may be complicated to get permission.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="radio" name="GEf4EtQ1AZxTFhTw-3" value="C" />
                                        <span class="opt-code">C</span>
                            ...
                            <fieldset class="q-item" data-q="5">
                                ...
                                <div class="q-options" role="radiogroup" aria-label="Question 1 options">
                                    <label class="q-option">
                                        <input type="radio" name="GEf4EtQ1AZxTFhTw-5" value="A" />
                                        <span class="opt-code">A</span>
                                        <span class="opt-label">other types of food supplement.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="radio" name="GEf4EtQ1AZxTFhTw-5" value="B" />
                                        <span class="opt-code">B</span>
                                        <span class="opt-label">different genetic strains of mice.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="radio" name="GEf4EtQ1AZxTFhTw-5" value="C" />
                                        <span class="opt-code">C</span>
                ...
                <div class="qa highlighted-content">
                    <form class="qa-body" id="form-nc2">
                        <fieldset class="q-item">
                            ...
                            <div class="audio-player" data-player role="group" aria-label="Audio controls">
                                <audio preload="auto"
                                    src="https://engnovate.com/wp-content/uploads/2024/08/cambridge-ielts-19-academic-listening-3-audio-4.mp3">
                                </audio>
                        ...
                        <fieldset class="q-item">
                            ...
                            <p>
                                fibres from some
                                <span class="q-number-box">1</span>
                                <input type="text" name="GEf4EtQ1AZxTFhTw-7" class="q-text"
                                    placeholder="">
                                during washing
                            </p>
                            ...
                            <p>
                                ...
                                <span class="q-number-box">2</span>
                                <input type="text" name="GEf4EtQ1AZxTFhTw-8" class="q-text"
                                    placeholder="">
                            ...
                            <p>
                                ...
                                <span class="q-number-box">3</span>
                                <input type="text" name="GEf4EtQ1AZxTFhTw-9" class="q-text"
                                    placeholder="">
                                and seafood.
                            </p>
                            ...
                            <p>
                                ...
                                <span class="q-number-box">4</span>
                                <input type="text" name="GEf4EtQ1AZxTFhTw-10" class="q-text"
                                    placeholder="">
                                in some countries.
                            </p>
                            ...
                            <p>
                                ...
                                <span class="q-number-box">5</span>
                                <input type="text" name="GEf4EtQ1AZxTFhTw-11" class="q-text"
                                    placeholder="">
                            </p>
                            ...
                            <p>
                                ...
                                <span class="q-number-box">6</span>
                                <input type="text" name="GEf4EtQ1AZxTFhTw-12" class="q-text"
                                    placeholder="">
                                to the soil.
                            </p>
                            ...
                            <p>
                                ...
                                <input type="text" name="GEf4EtQ1AZxTFhTw-14" class="q-text"
                                    placeholder="">
                                of plants.
                            </p>
                            ...
                            <p>
                                ...
                                <input type="text" name="GEf4EtQ1AZxTFhTw-15" class="q-text"
                                    placeholder="">
                                loss in earthworms
                            </p>
                            ...
                            <p>
                                ...
                                <input type="text" name="GEf4EtQ1AZxTFhTw-16" class="q-text"
                                    placeholder="">
                                in the soil.
                            </p>
                            ...
                            <p>
                                ...
                                <input type="text" name="GEf4EtQ1AZxTFhTw-17" class="q-text"
                                    placeholder="">
                            </p>
    ...
    <script>
        ...
        $("#submit-nc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc", "GEf4EtQ1AZxTFhTw", "nc", $(this), "again-nc");
        });

        $("#submit-nc2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc2", "GEf4EtQ1AZxTFhTw", "nc", $(this), "again-nc2");
        });

        $("#submit-nc3").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc3", "GEf4EtQ1AZxTFhTw", "nc", $(this), "again-nc3");
        });

        $("#submit-nc4").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc4", "GEf4EtQ1AZxTFhTw", "nc", $(this), "again-nc4");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-oc", "GEf4EtQ1AZxTFhTw", "oc", $(this), "again-oc");
        });
        ...
        $("#submit-two_choices").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-two_choices", "GEf4EtQ1AZxTFhTw", "two_choices", $(this), "again-two_choices");
        });
    </script>
