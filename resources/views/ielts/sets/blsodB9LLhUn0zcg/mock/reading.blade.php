            ...
            $tabs = [
                ...
                'data' => [
                    'part1' => [
                        ...
                        'tipe' => ['tfng', 'tc'],
                        'contents' => [
                            'answer' => 'partials.blsodB9LLhUn0zcg.mock.reading.part1.answer',
                            'question' => 'partials.blsodB9LLhUn0zcg.mock.reading.part1.question',
                        ],
                    ],
                    'part2' => [
                        'label' => 'Part 2',
                        'tipe' => ['mh', 'nc', 'two_choices'],
                        'contents' => [
                            'answer' => 'partials.blsodB9LLhUn0zcg.mock.reading.part2.answer',
                            'question' => 'partials.blsodB9LLhUn0zcg.mock.reading.part2.question',
                        ],
                    ],
                    'part3' => [
                        'label' => 'Part 3',
                        'tipe' => ['oc', 'summary_completion', 'matching_features'],
                        'contents' => [
                            'answer' => 'partials.blsodB9LLhUn0zcg.mock.reading.part3.answer',
                            'question' => 'partials.blsodB9LLhUn0zcg.mock.reading.part3.question',
                        ],
                    ],
                ],
            ];
