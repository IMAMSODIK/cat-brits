                        ...
                        <div class="reading-grid resizable-grid">
                            <article class="passage" aria-label="Reading Passage" tabindex="0">
                                <div class="passage-body">
                                    <p>The charts below show the changes in ownership of electrical appliances and
                                        amount of
                                        time spent doing housework and households in one country between 1920 and 2019..
                                    </p>
                                    <p>Summarize the information by selecting and reporting the main features, and make
                                    </p>
                ...
                <div id="panel-tfng2" class="x-panel" role="tabpanel" aria-labelledby="tab-tfng2">
                    ...
                    <div class="reading-section" aria-label="Reading and Questions">
                        <div class="reading-grid resizable-grid">
                            <article class="passage" aria-label="Reading Passage" tabindex="0">
                                <div class="passage-body">
                                    <p>In some countries, more and more people are becoming interested in finding out
                                        about
