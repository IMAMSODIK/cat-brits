        ...
        @php
            $tabs = [
                ...
                'data' => [
                    'part1' => [
                        'label' => 'Part 1',
                        'tipe' => ['sentence_completion', 'tc', 'tfng'],
                        'contents' => [
                            'answer' => 'partials.KeCD0au8jSaBuT3A.mock.reading.part1.answer',
                            'question' => 'partials.KeCD0au8jSaBuT3A.mock.reading.part1.question',
                        ],
                    ],
                    'part2' => [
                        'label' => 'Part 2',
                        'tipe' => ['matching_information', 'matching_features', 'sentence_completion'],
                        'contents' => [
                            'answer' => 'partials.KeCD0au8jSaBuT3A.mock.reading.part2.answer',
                            'question' => 'partials.KeCD0au8jSaBuT3A.mock.reading.part2.question',
                        ],
                    ],
                    'part3' => [
                        'label' => 'Part 3',
                        'tipe' => ['matching_information', 'summary_completion', 'matching_features'],
                        'contents' => [
                            'answer' => 'partials.KeCD0au8jSaBuT3A.mock.reading.part3.answer',
                            'question' => 'partials.KeCD0au8jSaBuT3A.mock.reading.part3.question',
                        ],
                    ],
                ],
            ];
        @endphp
        <x-tabs.mock :tabs="$tabs" />
    </section>
