...
<body>
    ...
    <script>
        ...
        $("#submit-mh").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-mh", "QmN0FYAE2DCXRPdC", "mh");
        });

        $("#submit-tfng").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-tfng", "QmN0FYAE2DCXRPdC", "tfng");
        });
        ...
        $("#submit-matching_features").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-matching_features", "QmN0FYAE2DCXRPdC", "matching_features");
        });

        $("#submit-sentence_completion").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-sentence_completion", "QmN0FYAE2DCXRPdC", "sentence_completion");
        });

        $("#submit-summary_completion").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-summary_completion", "QmN0FYAE2DCXRPdC", "summary_completion");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-one", "QmN0FYAE2DCXRPdC", "oc");
        });

        $("#submit-ynng").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-ynng", "QmN0FYAE2DCXRPdC", "ynng");
        });
    </script>
