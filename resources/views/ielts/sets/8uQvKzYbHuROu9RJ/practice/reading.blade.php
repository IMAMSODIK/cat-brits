...
<body>
                        ...
                        <aside class="qa" aria-label="Questions">
                            <form class="qa-body" id="form-summary_completion2">
                                ...
                                <div style="text-align: center;">
                                    ...
                                    <button type="button" class="btn btn-primary" data-kategori="reading"
                                        data-count="3" id="submit-summary_completion2">
                                        Submit
                                    </button>
                                </div>
                            </form>
    ...
    <script>
        ...
        $("#submit-summary_completion").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-summary_completion", "8uQvKzYbHuROu9RJ", "summary_completion", $(this), "again-matching_information", "Summary Completion");
        });

        $("#submit-matching_features").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-matching_features", "8uQvKzYbHuROu9RJ", "matching_features", $(this), "again-matching_information", "Matching Features");
        });

        $("#submit-mh").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-mh", "8uQvKzYbHuROu9RJ", "mh", $(this), "again-mh", "Matching Headnings");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-one", "8uQvKzYbHuROu9RJ", "oc", $(this), "again-oc", "One Choice");
        });

        $("#submit-summary_completion2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-summary_completion2", "8uQvKzYbHuROu9RJ", "summary_completion", $(this), "again-summary_completion2", "Summary Completion");
        });

        $("#submit-oc2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-one2", "8uQvKzYbHuROu9RJ", "oc", $(this), "again-oc2", "One Choice");
        });

        $("#submit-summary_completion3").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-summary_completion3", "8uQvKzYbHuROu9RJ", "summary_completion", $(this), "again-summary_completion3", "Summary ompletion");
        });

        $("#submit-ynng").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-ynng", "8uQvKzYbHuROu9RJ", "ynng", $(this), "again-ynng", "Yes, No or Not Given");
        });
    </script>
