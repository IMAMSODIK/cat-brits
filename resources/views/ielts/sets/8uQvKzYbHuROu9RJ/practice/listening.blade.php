...
<body>
                    ...
                    <div class="qa">
                        <form class="qa-body" id="form-form_completion">
                            ...
                            <div style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-primary" id="submit-form_completion">
                                    Submit
                                </button>
                            </div>
                        </form>
    ...
    <script>
        ...
        $("#submit-nc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc", "8uQvKzYbHuROu9RJ", "nc", $(this), "again-nc");
        });

        $("#submit-nc2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc2", "8uQvKzYbHuROu9RJ", "nc", $(this), "again-nc2");
        });

        $("#submit-nc3").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc3", "8uQvKzYbHuROu9RJ", "nc", $(this), "again-nc3");
        });

        $("#submit-nc4").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc4", "8uQvKzYbHuROu9RJ", "nc", $(this), "again-nc4");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-oc", "8uQvKzYbHuROu9RJ", "oc", $(this), "again-oc");
        });
        ...
        $("#submit-two_choices").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-two_choices", "8uQvKzYbHuROu9RJ", "two_choices", $(this), "again-two_choices");
        });
    </script>
