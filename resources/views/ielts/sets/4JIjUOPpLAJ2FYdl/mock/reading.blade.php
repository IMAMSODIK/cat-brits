                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-4JIjUOPpLAJ2FYdl-1" class="q-text" placeholder="">
                                        . In addition, it has been suggested that the dogs could have
                                        <span class="q-number-box">38</span>
                                        <input type="text" name="summary_completion-4JIjUOPpLAJ2FYdl-2" class="q-text" placeholder="">
                                        which may affect other species, and that they may reduce the amount of
                                        <span class="q-number-box">39</span>
                                        <input type="text" name="summary_completion-4JIjUOPpLAJ2FYdl-3" class="q-text" placeholder="">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-4JIjUOPpLAJ2FYdl-4" class="q-text" placeholder="">
                                    </p>
                                </fieldset>
                            </form>
                        </aside>
