...
<body>
    ...
    <script>
        ...
        $("#submit-nc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc", "IgWhHunhjhOYd3hb", "nc", $(this), "again-nc");
        });

        $("#submit-nc2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc2", "IgWhHunhjhOYd3hb", "nc", $(this), "again-nc2");
        });

        $("#submit-nc3").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc3", "IgWhHunhjhOYd3hb", "nc", $(this), "again-nc3");
        });

        $("#submit-nc4").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc4", "IgWhHunhjhOYd3hb", "nc", $(this), "again-nc4");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-oc", "IgWhHunhjhOYd3hb", "oc", $(this), "again-oc");
        });
        ...
        $("#submit-two_choices").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-two_choices", "IgWhHunhjhOYd3hb", "two_choices", $(this), "again-two_choices");
        });
    </script>
