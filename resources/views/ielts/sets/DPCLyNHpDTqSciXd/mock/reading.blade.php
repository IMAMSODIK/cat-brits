            ...
            $tabs = [
                ...
                'data' => [
                    'part1' => [
                        ...
                        'tipe' => ['nc', 'tfng'],
                        'contents' => [
                            'answer' => 'partials.DPCLyNHpDTqSciXd.mock.reading.part1.answer',
                            'question' => 'partials.DPCLyNHpDTqSciXd.mock.reading.part1.question',
                        ],
                    ],
                    'part2' => [
                        'label' => 'Part 2',
                        ...
                        'contents' => [
                            'answer' => 'partials.DPCLyNHpDTqSciXd.mock.reading.part2.answer',
                            'question' => 'partials.DPCLyNHpDTqSciXd.mock.reading.part2.question',
                        ],
                    ],
                    'part3' => [
                        'label' => 'Part 3',
                        'tipe' => ['oc', 'ynng', 'summary_completion'],
                        'contents' => [
                            'answer' => 'partials.DPCLyNHpDTqSciXd.mock.reading.part3.answer',
                            'question' => 'partials.DPCLyNHpDTqSciXd.mock.reading.part3.question',
                        ],
                    ],
                ],
            ];
