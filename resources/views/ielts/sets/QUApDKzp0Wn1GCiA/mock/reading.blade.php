                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-QUApDKzp0Wn1GCiA-1" data-type="summary_completion" data-q="18" class="q-text" placeholder="">
                                        , then into a residential area and finally into an arena where spectators could watch
                                        <span class="q-number-box">19</span>
                                        <input type="text" name="summary_completion-QUApDKzp0Wn1GCiA-2" data-type="summary_completion" data-q="19" class="q-text" placeholder="">
                                        ...
                                        <input type="text" name="summary_completion-QUApDKzp0Wn1GCiA-3" data-type="summary_completion" data-q="20" class="q-text" placeholder="">
                                        ...
                                        <input type="text" name="summary_completion-QUApDKzp0Wn1GCiA-4" data-type="summary_completion" data-q="21" class="q-text" placeholder="">
                                        . It is now a market square with
                                        <span class="q-number-box">22</span>
                                        <input type="text" name="summary_completion-QUApDKzp0Wn1GCiA-5" data-type="summary_completion" data-q="22" class="q-text" placeholder="">
                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <select name="summary_completion-QUApDKzp0Wn1GCiA-6" data-type="summary_completion" data-q="27" class="q-dropdown">
                                                    <option value=""></option>
                                                    <option value="A">A</option>
                                                    <option value="B">B</option>
                                                    <option value="C">C</option>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <select name="summary_completion-QUApDKzp0Wn1GCiA-7" data-type="summary_completion" data-q="28" class="q-dropdown">
                                                    <option value=""></option>
                                                    <option value="A">A</option>
                                                    <option value="B">B</option>
                                                    <option value="C">C</option>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <select name="summary_completion-QUApDKzp0Wn1GCiA-8" data-type="summary_completion" data-q="29" class="q-dropdown">
                                                    <option value=""></option>
                                                    <option value="A">A</option>
                                                    <option value="B">B</option>
                                                    <option value="C">C</option>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <select name="summary_completion-QUApDKzp0Wn1GCiA-9" data-type="summary_completion" data-q="30" class="q-dropdown">
                                                    <option value=""></option>
                                                    <option value="A">A</option>
                                                    <option value="B">B</option>
                                                    <option value="C">C</option>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <select name="summary_completion-QUApDKzp0Wn1GCiA-10" data-type="summary_completion" data-q="31" class="q-dropdown">
                                                    <option value=""></option>
                                                    <option value="A">A</option>
                                                    <option value="B">B</option>
                                                    <option value="C">C</option>
                                ...
                                <fieldset class="q-item" data-type="oc" data-q="36">
                                    <legend class="q-text">
