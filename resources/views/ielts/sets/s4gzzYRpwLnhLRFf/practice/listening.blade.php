...
<body>
    ...
    <script>
        ...
        $("#submit-matching_information2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-matching_information2", "s4gzzYRpwLnhLRFf", "matching_information");
        });

        $("#submit-form_completion").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-form_completion", "s4gzzYRpwLnhLRFf", "form_completion");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-oc", "s4gzzYRpwLnhLRFf", "oc");
        });

        $("#submit-oc2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-oc2", "s4gzzYRpwLnhLRFf", "oc");
        });

        $("#submit-tc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-tc", "s4gzzYRpwLnhLRFf", "tc");
        });

        $("#submit-two_choices").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-two_choices", "s4gzzYRpwLnhLRFf", "two_choices");
        });

        $("#submit-two_choices2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-two_choices2", "s4gzzYRpwLnhLRFf", "two_choices");
        });
    </script>
