                        ...
                        <div class="reading-grid resizable-grid">
                            <article class="passage" aria-label="Reading Passage" tabindex="0">
                                <div class="passage-body">
                                    <p>The charts below show what UK graduate and postgraduate students who did not go into full-time work did after leaving college in 2008</p>
                                    <p>Summarise the information by selecting and reporting the main features, and make comparisons where relevant.</p>
                                    <img src="{{ asset('own_assets/images/cambridge-ielts-10-academic-writing-test-3-1.png') }}"
                                        alt="" width="100%">
                                </div>
                            </article>
                ...
                <div id="panel-tfng2" class="x-panel" role="tabpanel" aria-labelledby="tab-tfng2">
                    ...
                    <div class="reading-section" aria-label="Reading and Questions">
                        <div class="reading-grid resizable-grid">
                            <article class="passage" aria-label="Reading Passage" tabindex="0">
                                <div class="passage-body">
                                    <p>Countries are becoming more and more similar because people can buy the same products anywhere in the world.</p>
