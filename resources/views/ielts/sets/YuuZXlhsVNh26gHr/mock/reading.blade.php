        ...
        @php
            $tabs = [
                ...
                'data' => [
                    'part1' => [
                        'label' => 'Part 1',
                        'tipe' => ['matching_information', 'ynng', 'matching_features'],
                        'contents' => [
                            'answer' => 'partials.YuuZXlhsVNh26gHr.mock.reading.part1.answer',
                            'question' => 'partials.YuuZXlhsVNh26gHr.mock.reading.part1.question',
                        ],
                    ],
                    'part2' => [
                        'label' => 'Part 2',
                        'tipe' => ['matching_information', 'two_choices', 'summary_completion'],
                        'contents' => [
                            'answer' => 'partials.YuuZXlhsVNh26gHr.mock.reading.part2.answer',
                            'question' => 'partials.YuuZXlhsVNh26gHr.mock.reading.part2.question',
                        ],
                    ],
                    'part3' => [
                        'label' => 'Part 3',
                        'tipe' => ['matching_features', 'ynng', 'summary_completion'],
                        'contents' => [
                            'answer' => 'partials.YuuZXlhsVNh26gHr.mock.reading.part3.answer',
                            'question' => 'partials.YuuZXlhsVNh26gHr.mock.reading.part3.question',
                        ],
                    ],
                ],
            ];
