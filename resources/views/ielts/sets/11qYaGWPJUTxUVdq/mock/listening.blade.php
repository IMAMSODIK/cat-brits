                            ...
                            <table border="1" cellpadding="8" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <hr>
                                        <div class="q-item" data-q="8" style="margin-top: 10px;">
                                    ...
                                    <td>
                                        ...
                                        <hr>
                                        <div class="q-item" data-q="9" style="margin-top: 10px;">
                    ...
                    <form class="qa-body">
                        ...
                        <table border="1" cellpadding="8" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="q-item" data-q="17" style="margin-top: 10px;">
                                        the mine is
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="q-item" data-q="18" style="margin-top: 10px;">
                                ...
                                <td>
                                    <div class="q-item" data-q="19" style="margin-top: 10px;">
                                        a
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="q-item" data-q="20" style="margin-top: 10px;">
            ...
            <div class="qa highlighted-content">
                <form class="qa-body">
                    ...
                    <fieldset class="q-item" data-q="7">
                        ...
                        <div class="q-options" role="radiogroup" aria-label="Question 2 options">
                            <label class="q-option">
                                <input type="radio" name="oc-11qYaGWPJUTxUVdq-27" value="A" />
                                <span class="opt-code">A</span>
                                <span class="opt-label">should be restricted to secure environments.</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="oc-11qYaGWPJUTxUVdq-27" value="B" />
                                <span class="opt-code">B</span>
                                <span class="opt-label">should be used with more caution.</span>
                            </label>
                            <label class="q-option">
                                <input type="radio" name="oc-11qYaGWPJUTxUVdq-27" value="C" />
                                <span class="opt-code">C</span>
