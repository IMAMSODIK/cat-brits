                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div class="q-list" data-q="9">
                                                ...
                                                <input type="text" name="summary_completion-XW16JROLKCFE4BMH-1" class="q-text" placeholder="">
                                            </div>
                                        </li>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="q-list" data-q="10">
                                                ...
                                                <input type="text" name="summary_completion-XW16JROLKCFE4BMH-2" class="q-text" placeholder="">
                                                from the 1070s
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="q-list" data-q="11">
                                                ...
                                                <input type="text" name="summary_completion-XW16JROLKCFE4BMH-3" class="q-text" placeholder="">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div class="q-list" data-q="12">
                                                ...
                                                <input type="text" name="summary_completion-XW16JROLKCFE4BMH-4" class="q-text" placeholder="">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="q-list" data-q="13">
                                                ...
                                                <input type="text" name="summary_completion-XW16JROLKCFE4BMH-5" class="q-text" placeholder="">
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-XW16JROLKCFE4BMH-6" class="q-text" placeholder="">
                                        ...
                                        <input type="text" name="summary_completion-XW16JROLKCFE4BMH-7" class="q-text" placeholder="">
                                        .
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-XW16JROLKCFE4BMH-8" class="q-text" placeholder="">
                                        , our overuse of antibiotics, and our excessive focus on
                                        <span class="q-number-box">20</span>
                                        <input type="text" name="summary_completion-XW16JROLKCFE4BMH-9" class="q-text" placeholder="">
                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-XW16JROLKCFE4BMH-10" class="q-text" placeholder="">
                                        regarding the extent of our knowledge, and to take into account
                                        <span class="q-number-box">32</span>
                                        <input type="text" name="summary_completion-XW16JROLKCFE4BMH-11" class="q-text" placeholder="">
                                        which may not be the same as our own. We should also be able to take a broad
                                        <span class="q-number-box">33</span>
                                        <input type="text" name="summary_completion-XW16JROLKCFE4BMH-12" class="q-text" placeholder="">
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="summary_completion-XW16JROLKCFE4BMH-13" class="q-text" placeholder="">
                                        . By avoiding the first-person perspective, we focus more on
                                        <span class="q-number-box">35</span>
                                        <input type="text" name="summary_completion-XW16JROLKCFE4BMH-14" class="q-text" placeholder="">
