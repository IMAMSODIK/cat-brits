                        ...
                        <div class="reading-grid resizable-grid">
                            <article class="passage" aria-label="Reading Passage" tabindex="0">
                                <div class="passage-body">
                                    <p>The chart below shows the number of households in the US by their annual ’ income
                                        in 2007, 2011 and 2015.</p>
                                    <p>Summarise the information by selecting and reporting the main features, and make
                                        comparisons where relevant.</p>
                                    <img src="{{ asset('own_assets/images/cambridge-ielts-18-academic-writing-test-2-1.jpg') }}"
                                        alt="" width="100%">
                                </div>
                            </article>
                ...
                <div id="panel-tfng2" class="x-panel" role="tabpanel" aria-labelledby="tab-tfng2">
                    ...
                    <div class="reading-section" aria-label="Reading and Questions">
                        <div class="reading-grid resizable-grid">
                            <article class="passage" aria-label="Reading Passage" tabindex="0">
                                <div class="passage-body">
                                    <p>Some university students want to learn about other subjects in addition to their
                                        main subjects. Others believe it is more important to give all their time and
                                        attention to studying for a qualification.</p>
