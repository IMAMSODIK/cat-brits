...
<body>
                    ...
                    <div class="qa highlighted-content" aria-label="Questions">
                        <form class="qa-body" id="form-map_labeling">
                            ...
                            <div style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-primary" id="submit-map_labeling">
                                    Submit
                                </button>
                            </div>
                        </form>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="q-list" data-q="6">
                                            ...
                                            <input type="text" name="JSRJ0oDlxC0yFMgt-16" class="q-text" placeholder="">
                                    ...
                                    <li>
                                        <div class="q-list" data-q="7">
                                            ...
                                            <input type="text" name="JSRJ0oDlxC0yFMgt-17" class="q-text" placeholder="">
                                    ...
                                    <li>
                                        <div class="q-list" data-q="8">
                                            ...
                                            <input type="text" name="JSRJ0oDlxC0yFMgt-18" class="q-text" placeholder="">
                                    ...
                                    <li>
                                        <div class="q-list" data-q="9">
                                            ...
                                            <input type="text" name="JSRJ0oDlxC0yFMgt-19" class="q-text" placeholder="">
                                            of women.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="q-list" data-q="10">
                                            ...
                                            <input type="text" name="JSRJ0oDlxC0yFMgt-20" class="q-text" placeholder="">
                                        </div>
                                    </li>
                                </ul>
                            </fieldset>
    ...
    <script>
        ...
        $("#submit-nc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc", "JSRJ0oDlxC0yFMgt", "nc", $(this), "again-nc");
        });

        $("#submit-nc2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc2", "JSRJ0oDlxC0yFMgt", "nc", $(this), "again-nc2");
        });

        $("#submit-nc3").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc3", "JSRJ0oDlxC0yFMgt", "nc", $(this), "again-nc3");
        });

        $("#submit-nc4").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc4", "JSRJ0oDlxC0yFMgt", "nc", $(this), "again-nc4");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-oc", "JSRJ0oDlxC0yFMgt", "oc", $(this), "again-oc");
        });
        ...
        $("#submit-two_choices").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-two_choices", "JSRJ0oDlxC0yFMgt", "two_choices", $(this), "again-two_choices");
        });
    </script>
