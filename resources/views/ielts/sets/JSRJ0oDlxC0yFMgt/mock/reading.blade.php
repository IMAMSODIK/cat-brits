                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item" data-q="9">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 9 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-1" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-1" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-1" value="NOT GIVEN" />
                                ...
                                <fieldset class="q-item" data-q="10">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 10 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-2" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-2" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-2" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="11">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 11 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-3" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-3" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-3" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="12">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 12 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-4" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-4" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-4" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="13">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 13 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-5" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-5" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-5" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item" data-q="14">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 14 options">
                                        ...
                                        <label class="q-option">
                                            <input type="radio" name="oc-JSRJ0oDlxC0yFMgt-1" value="D" />
                                ...
                                <fieldset class="q-item" data-q="15">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 15 options">
                                        ...
                                        <label class="q-option">
                                            <input type="radio" name="oc-JSRJ0oDlxC0yFMgt-2" value="D" />
                                            <span class="opt-code">D</span>
                                ...
                                <fieldset class="q-item" data-q="16">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 16 options">
                                        ...
                                        <label class="q-option">
                                            <input type="radio" name="oc-JSRJ0oDlxC0yFMgt-3" value="D" />
                                            <span class="opt-code">D</span>
                                ...
                                <fieldset class="q-item" data-q="17">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 17 options">
                                        ...
                                        <label class="q-option">
                                            <input type="radio" name="oc-JSRJ0oDlxC0yFMgt-4" value="D" />
                                            <span class="opt-code">D</span>
                                ...
                                <fieldset class="q-item" data-q="20">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 20 options">
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-1" value="YES" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">YES</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-1" value="NO" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">NO</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-1" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="21">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 21 options">
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-2" value="YES" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">YES</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-2" value="NO" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">NO</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-2" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="22">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 22 options">
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-3" value="YES" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">YES</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-3" value="NO" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">NO</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-3" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="23">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 23 options">
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-4" value="YES" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">YES</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-4" value="NO" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">NO</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="ynng-JSRJ0oDlxC0yFMgt-4" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                    ...
                                    <p>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <select name="summary_completion-JSRJ0oDlxC0yFMgt-1" class="q-dropdown">
                                                    <option value=""></option>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <select name="summary_completion-JSRJ0oDlxC0yFMgt-2" class="q-dropdown">
                                                    <option value=""></option>
                                                    <option value="A">A</option>
                                                    <option value="B">B</option>
                                                    <option value="C">C</option>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <select name="summary_completion-JSRJ0oDlxC0yFMgt-3" class="q-dropdown">
                                                    <option value=""></option>
                                                    <option value="A">A</option>
                                                    <option value="B">B</option>
                                                    <option value="C">C</option>
                            ...
                            <form class="qa-body">
                                ...
                                <fieldset class="q-item" data-q="27">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 27 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-6" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-6" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-6" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="28">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 28 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-7" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-7" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-7" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="29">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 29 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-8" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-8" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-8" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="30">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 30 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-9" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-9" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-9" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="31">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 31 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-10" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-10" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-10" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="32">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 32 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-11" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-11" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-11" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item" data-q="32">
                                    ...
                                    <div class="q-options" role="radiogroup" aria-label="Question 32 options">
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-12" value="TRUE" />
                                            <span class="opt-code">A</span>
                                            <span class="opt-label">TRUE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-12" value="FALSE" />
                                            <span class="opt-code">B</span>
                                            <span class="opt-label">FALSE</span>
                                        </label>
                                        <label class="q-option">
                                            <input type="radio" name="tfng-JSRJ0oDlxC0yFMgt-12" value="NOT GIVEN" />
                                            <span class="opt-code">C</span>
                                            <span class="opt-label">NOT GIVEN</span>
                                        </label>
                                    </div>
                                ...
                                <fieldset class="q-item">
                                    ...
                                    <p>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <input type="text" name="summary_completion-JSRJ0oDlxC0yFMgt-4" class="q-text"
                                                    placeholder="">
                                            </span>
                                        </span>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <input type="text" name="summary_completion-JSRJ0oDlxC0yFMgt-5" class="q-text"
                                                    placeholder="">
                                            </span>
                                        </span>
                                    ...
                                    <p>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <input type="text" name="summary_completion-JSRJ0oDlxC0yFMgt-6" class="q-text"
                                                    placeholder="">
                                            </span>
                                        </span>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <input type="text" name="summary_completion-JSRJ0oDlxC0yFMgt-7" class="q-text"
                                                    placeholder="">
                                            </span>
                                        </span>
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <input type="text" name="summary_completion-JSRJ0oDlxC0yFMgt-8" class="q-text"
                                                    placeholder="">
                                            </span>
                                        </span>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <input type="text" name="summary_completion-JSRJ0oDlxC0yFMgt-9" class="q-text"
                                                    placeholder="">
                                            </span>
                                        </span>
                                        ...
                                        <span style="flex: 1;">
                                            <span class="q-question">
                                                <input type="text" name="summary_completion-JSRJ0oDlxC0yFMgt-10" class="q-text"
                                                    placeholder="">
                                            </span>
                                        </span>
