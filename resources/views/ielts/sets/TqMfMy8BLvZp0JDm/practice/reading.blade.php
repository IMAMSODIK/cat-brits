...
<body>
                        ...
                        <aside class="qa" aria-label="Questions">
                            <form class="qa-body" id="form-diagram_labeling">
                                ...
                                <div style="text-align: center;">
                                    <button  type="button" class="btn btn-primary try-again" id="again-diagram_labeling" style="display: none">
                                        Try Again
                                    </button>
                                    <button type="button" class="btn btn-primary" id="submit-diagram_labeling">
                                        Submit
                                    </button>
                                </div>
                            </form>
                    ...
                    <div class="reading-grid resizable-grid highlighted-content">
                        ...
                        <aside class="qa" aria-label="Questions">
                            <form class="qa-body" id="form-ynng2">
                                ...
                                <div style="text-align: center;">
                                    <button  type="button" class="btn btn-primary try-again" id="again-ynng2" style="display: none">
                                        Try Again
                                    </button>
                                    <button type="button" class="btn btn-primary" id="submit-ynng2">
                                        Submit
                                    </button>
                                </div>
                            </form>
    ...
    <script>
        ...
        $("#submit-tfng").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-tfng", "TqMfMy8BLvZp0JDm", "tfng", $(this), "again-tfng");
        });

        $("#submit-tfng2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-tfng2", "TqMfMy8BLvZp0JDm", "tfng", $(this), "again-tfng2");
        });

        $("#submit-ynng").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-ynng", "TqMfMy8BLvZp0JDm", "ynng", $(this), "again-ynng");
        });

        $("#submit-mse").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-mse", "TqMfMy8BLvZp0JDm", "mse", $(this), "again-mse");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-one", "TqMfMy8BLvZp0JDm", "oc", $(this), "again-oc");
        });

        $("#submit-mh").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-mh", "TqMfMy8BLvZp0JDm", "mh", $(this), "again-mh");
        });

        $("#submit-tc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-tc", "TqMfMy8BLvZp0JDm", "tc", $(this), "again-tc");
        });

        $("#submit-sa").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-sa", "TqMfMy8BLvZp0JDm", "sa", $(this), "again-sa");
        });
    </script>
