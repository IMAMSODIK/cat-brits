...
<body>
    ...
    <section class="parts-section" aria-label="Pilihan Part Soal">
        <div class="x-tabs" role="tablist" aria-label="Jenis Soal" data-active="tc">
            <button class="x-tab is-active" role="tab" id="tab-tc" aria-controls="panel-tc" aria-selected="true"
                data-id="tc">Note Completion</button>
        ...
        <div class="x-panels">
            <div id="panel-tc" class="x-panel is-open" role="tabpanel" aria-labelledby="tab-tc">
                    ...
                    <div class="qa highlighted-content" aria-label="Questions">
                        <form class="qa-body" id="form-two_choices4">
                            ...
                            <div style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-primary" id="submit-two_choices4">
                                    Submit
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="qa highlighted-content" aria-label="Questions">
                        <form class="qa-body" id="form-two_choices5">
                            ...
                            <div style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-primary" id="submit-two_choices5">
                                    Submit
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="qa highlighted-content" aria-label="Questions">
                        <form class="qa-body" id="form-two_choices6">
                            ...
                            <fieldset class="q-item" data-q="1" data-q-multi="1,2" data-max="2">
                                ...
                                <div class="q-options" role="group" aria-label="Question 1 options">
                                    <label class="q-option">
                                        <input type="checkbox" name="xQKeqKYrkqfdgotg-11[]" value="A" />
                                        <span class="opt-code">A</span>
                                        <span class="opt-label">It has little practical relevance.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="checkbox" name="xQKeqKYrkqfdgotg-11[]" value="B" />
                                        <span class="opt-code">B</span>
                                        <span class="opt-label">It needs further investigation.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="checkbox" name="xQKeqKYrkqfdgotg-11[]" value="C" />
                                        <span class="opt-code">C</span>
                                        <span class="opt-label">It is misleading.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="checkbox" name="xQKeqKYrkqfdgotg-11[]" value="D" />
                                        <span class="opt-code">D</span>
                                        <span class="opt-label">It should be more widely accepted.</span>
                                    </label>
                                    <label class="q-option">
                                        <input type="checkbox" name="xQKeqKYrkqfdgotg-11[]" value="E" />
                                        <span class="opt-code">E</span>
                            ...
                            <div style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-primary" id="submit-two_choices6">
                                    Submit
                                </button>
                            </div>
                        </form>
    ...
    <script>
        ...
        $("#submit-nc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc", "xQKeqKYrkqfdgotg", "nc", $(this), "again-nc");
        });

        $("#submit-nc2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc2", "xQKeqKYrkqfdgotg", "nc", $(this), "again-nc2");
        });

        $("#submit-nc3").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc3", "xQKeqKYrkqfdgotg", "nc", $(this), "again-nc3");
        });

        $("#submit-nc4").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-nc4", "xQKeqKYrkqfdgotg", "nc", $(this), "again-nc4");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-oc", "xQKeqKYrkqfdgotg", "oc", $(this), "again-oc");
        });

        $("#submit-tc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-tc", "xQKeqKYrkqfdgotg", "tc", $(this), "again-tc");
        });

        $("#submit-two_choices").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-two_choices", "xQKeqKYrkqfdgotg", "two_choices", $(this), "again-two_choices");
        });
    </script>
