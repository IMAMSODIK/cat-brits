...
<body>
    ...
    <script>
        ...
        $("#submit-tfng").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-tfng", "xQKeqKYrkqfdgotg", "tfng", $(this), "again-tfng");
        });

        $("#submit-tfng2").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-tfng2", "xQKeqKYrkqfdgotg", "tfng", $(this), "again-tfng2");
        });

        $("#submit-ynng").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-ynng", "xQKeqKYrkqfdgotg", "ynng", $(this), "again-ynng");
        });

        $("#submit-mse").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-mse", "xQKeqKYrkqfdgotg", "mse", $(this), "again-mse");
        });

        $("#submit-oc").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-one", "xQKeqKYrkqfdgotg", "oc", $(this), "again-oc");
        });

        $("#submit-mh").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-mh", "xQKeqKYrkqfdgotg", "mh", $(this), "again-mh");
        });
        ...
        $("#submit-sa").on("click", function(e) {
            e.preventDefault();
            submitHelper("form-sa", "xQKeqKYrkqfdgotg", "sa", $(this), "again-sa");
        });
    </script>
