                                ...
                                <li class="d-flex top-product gap-2">
                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            ...
                                            </div><a class="f-10 f-w-500  line-clamp" href="product.html">Noise - Wireless
                                ...
                                <li class="d-flex top-product gap-2">
                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            ...
                                            </div><a class="f-10 f-w-500  line-clamp" href="product.html">Men &amp; Women
                                ...
                                <li class="d-flex top-product gap-2">
                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            ...
                                            </div><a class="f-10 f-w-500  line-clamp" href="product.html">Anime White Half
                                                Sleev
                                        ...
                                        <td>
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="subtitle">
                                                        <p class="f-w-400 f-10">Floyd has moved to the
                                                            warehouse.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="subtitle">
                                                        <p class="f-w-400 f-10">Ralph has solved
                                                            Mr.williams project.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="subtitle">
                                                        <p class="f-w-400 f-10">Esther has changed his to
                                                            active, now.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="subtitle">
                                                        <p class="f-w-400 f-10">Jacob has make changes in
                                                            sold it.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="subtitle">
                                                        <p class="f-w-400 f-10">Theresa has complete old
                                                            task and new one.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="subtitle">
                                                        <p class="f-w-400 f-10">Annette has send all the
                                                            stock to department.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div class="card-footer">
                        <div class="common-space">
                            <div><a class="f-w-600 f-14 " href="index.html">Most Visited Day</a><span
                                    class="f-light f-w-500 f-14 d-block">Total 59.6k visits on Sunday
                                </span></div>
